...
from agent_rag.the3rd_packages.document_split.extractor_handler import ExtractorHandler
from agent_rag.the3rd_packages.document_split.utils.get_filepath_list import get_file_path_list
from agent_rag.the3rd_packages.document_split.embedding.embedding_client import EmbeddingClient
from agent_rag.the3rd_packages.slice_database.chroma_database.chromadb_client import ChromadbClient
...
class DocumentExtractor:
    ...
    def save_slices_to_local_file(self):
        with open(f"F:/Cmodels/Agent_RAG/agent_rag/the3rd_packages/slice_database/local_database/{self.db_name}.json", "w", encoding="utf-8") as f:
            json.dump(self.all_slices, f, ensure_ascii=False, indent=4)
        print(f"slice save to 'F:/Cmodels/Agent_RAG/agent_rag/the3rd_packages/slice_database/local_database/{self.db_name}.json'")
        return
